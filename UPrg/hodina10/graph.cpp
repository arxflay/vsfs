...
edge *createEdge(int_fast32_t length, graphNode *node)
{
    edge *e{ new edge{} };
    e->length = length;
...
void createConnection(graphNode *node, graphNode *target, int_fast32_t length)
{
...
graphNode *createNode(int_fast64_t value, uint_least32_t depth )
{
